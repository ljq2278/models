...
def create_tf_example(image,
  ...
  full_path = os.path.join(image_dir, filename.split('_')[0],filename)
  ...
  for object_annotations in annotations_list:
    ...
    if include_masks:
      ...
      run_len_encoding = mask.frPyObjects([list(np.reshape(object_annotations['segmentation'],-1))], image_height, image_width)
